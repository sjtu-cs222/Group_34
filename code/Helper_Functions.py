...
class WeightsAccountant:
    ...
    def Update_via_GaussianMechanism(self, sess, Acc, FLAGS, Computed_deltas):
        ...
        # Sanitized_Updates = [MeanClippedUpdates[i] for i in range(self.num_weights)]
        ...
        # ['hidden1/weights_placeholder:0', 'hidden2/weights_placeholder:0', 'out/weights_placeholder:0']

        print(self.Sigma, self.m, FLAGS.eps)
    ...
    if FLAGS.relearn == False:
        ...
        with open(save_dir + '/specs.csv', 'w') as csvfile:
            ...
            if FLAGS.priv_agent == True:
                ...
                print([0]+[PrivacyAgent.get_m(r) for r in range(len(Delta_accountant)-1)])
